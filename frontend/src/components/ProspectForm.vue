<template>
  ...
  >
      ...
      <div v-if="activeStep === 3">
        <el-descriptions :column="1" border>
          ...
          <el-descriptions-item label="Address"
            ...
            {{ form.country }}</el-descriptions-item
          >
          ...
          <el-descriptions-item label="Prospect Interest"
            >{{ form.prospect_interest }}/5</el-descriptions-item
          >
          <el-descriptions-item label="Commercial Interest"
            >{{ form.commercial_interest }}/5</el-descriptions-item
          >
          <el-descriptions-item label="Overall Interest"
            >{{
              form.prospect_interest + form.commercial_interest
    ...
    <template #footer>
      ...
      <el-button @click="nextStep" :disabled="activeStep === 3" type="primary">
        Next
      </el-button>
      <el-button
        v-if="activeStep === 3"
...
const rules = reactive<FormRules>({
  name: [
    { required: true, message: "Please input prospect name", trigger: "blur" },
  ],
  email: [
  ...
  if (formRef.value) {
    try {
      ...
      if (props.mode === "create") {
        await api.post("/api/v1/prospect/", payload);
      } else {
        await api.put(`/api/v1/prospect/${form.id}`, payload);
      }
