...
async def get_representative_mongo_id(
    representative_id: int, db: AsyncIOMotorDatabase
) -> Optional[ObjectId]:
    """
...
async def get_representative_code_by_mongo_id(
    mongo_id: ObjectId, db: AsyncIOMotorDatabase
) -> Optional[int]:
    """
